...
//	and a cyclops.  Each one moves through a 100x100 grid with some
...
// Checks : none
void GetCoordinates(char grid[][100], int HG[], int VG[], int H[]);
...
//			 in the grid.
// Checks : none
void PrintCoordinates(char grid[][100], int HG[], int VG[], int H[], int C[]);
// Requires : grid, HG, VG, C, and H have been declared
// Ensures : prints the coordinates of HG, VG, H, and C
// Checks : none
void RefreshGrid(char grid[][100], int HG[], int VG[], int H[], int C[]);
// Requires : grid, HG, VG, C, and H have been declared
...
{
	char grid[100][100];
	int HG[2], VG[2], H[2], tempHG[2], tempVG[2], C[2] = {50,50};
...
void GetCoordinates(char grid[][100], int HG[], int VG[], int H[])
{
	...
	cin >> VGrow >> VGcol;
	cout << "Enter coordinates of Hoogie: ";
	cin >> Hrow >> Hcol;
...
void RefreshGrid(char grid[][100], int HG[], int VG[], int H[], int C[])
{
	...
	if(HG[0] < 100)					//if gorgon is not alive, will not
